Feature: White Box test for getNumberOfWeekActivityForEmployee
  ...
  And a project with name "BaqerTest" with id "30000" exists
  ...
  And the activity "a1" from project with ID "30000" with the following details exits:
    ...
    | startWeek | 25-03       		|
    | endWeek   | 25-06     		  |
  When the user tests ID "huba" to count the number of aktivities in project with ID "30000" at week "25-56"
