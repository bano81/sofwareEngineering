Feature: Create and manage projects
    ...
    Scenario: Create a new project
        ...
        When the user tries to create a new project with name "NewProject" with id "25001"
    ...
    Scenario: Assign existing user as project manager
        ...
        When "huba" is assigned as project manager for the project with Id "NewProject"
